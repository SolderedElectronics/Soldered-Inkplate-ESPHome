...
#define INK_CKV_SET()   do { GPIO.out1_w1ts.val = (1u << (INK_GPIO_CKV - 32)); } while (0)
#define INK_CKV_CLEAR() do { GPIO.out1_w1tc.val = (1u << (INK_GPIO_CKV - 32)); } while (0)
#define INK_SPH_SET()   do { GPIO.out1_w1ts.val = (1u << (INK_GPIO_SPH - 32)); } while (0)
#define INK_SPH_CLEAR() do { GPIO.out1_w1tc.val = (1u << (INK_GPIO_SPH - 32)); } while (0)
#define INK_LE_SET()    do { GPIO.out_w1ts = (1u << INK_GPIO_LE); } while (0)
#define INK_LE_CLEAR()  do { GPIO.out_w1tc = (1u << INK_GPIO_LE); } while (0)
